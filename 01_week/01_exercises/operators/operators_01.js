...
// - Subtract b from a (difference).
let subtract = a - b;
console.log("Difference of a and be is:", subtract);

// - Multiply a and b (product).
let product = a * b;
...
// - Add a and b (sum).
let sum2 = a + b;
console.log("Sum of a and b is:", sum2);

// - Subtract b from a (difference).
let subtract2 = a - b;
console.log("Difference of a and be is:", subtract2);

// - Multiply a and b (product).
let product2 = a * b;
console.log("Product of a and b is:", product2);